...
#define MF522_PORT_RST     GPIOE
#define MF522_PIN_RST      GPIO_Pin_14
...
#define MF522_PORT_CS      GPIOE
#define MF522_PIN_CS       GPIO_Pin_15
...
void MF522_init(void)
{
	...
	//SDA: PE15 | SCK:PB10 | MOSI: PC3 | MISO: PC2 | RST: PE14
